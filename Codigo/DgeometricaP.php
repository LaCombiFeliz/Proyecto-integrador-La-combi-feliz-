...
<?php echo '<h3 style="text-align:center;">Ejemplo de distribucion geometrica para la cantidad de pasajeros no estudiantes que utilizan el transporte público</h3>';?>
...
// Ejemplo de uso
$valorDeseado = 4; // Tiempo sobre el que se estima
...
<table class="table" id="tablaDatos">
        <thead>
            ...
            <th><?php echo "La probabilidad de que el primer viaje vayan 4 o menos pasajeros no estudiantes  ocurra en exactamente 19 viajes: "?></th>
        </thead>
        <tbody>
            <tr>
