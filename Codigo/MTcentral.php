...
<?php echo '<h3 style="text-align:center;">Medidas de tendencia central para los tiempos de trayecto del transporte público</h3>';?>
...
<table border="5" class="table table-striped" id="tablaDatos1">
    <thead>
...
<script type="text/javascript">
    ...
    tooltip: {
        pointFormat: '<b>{point.y:.1f} minutos</b>'
    },
    series: [{
        name: 'Population',
        colors: [
