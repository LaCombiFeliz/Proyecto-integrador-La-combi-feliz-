...
<?php echo '<h3 style="text-align:center;">Medidas de tendencia central para la cantidad de pasajeros que utilizan el transporte publico</h3>';?>
...
for ($i = 0; $i < count($data1); $i++) {
    ...
    $datos[] = $resultado;
    $datosA[] = array("Dia"=>$data0[$i], "Cantidad"=>$resultado);
}
...
<table class="table" id="tablaDatos1" border="5">
    <thead>
...
<script type="text/javascript">
    ...
    title: {
        text: 'Cantidad de pasajeros que utilizan el transporte publico'
    },
    xAxis: {
        type: 'category'
    },
    ...
    series: [{
        color: '#FF0000' // Aquí puedes poner el color que prefieras
    }]
});
</script>
...
<table  id="tablaDatosC" class="table table-striped" border="5">
        <thead>
            <th>Fecha</th>
            <th>Media</th>
            <th>Mediana</th>
...
<script type="text/javascript">
    ...
    title: {
        text: 'Medidas de tendencia central para cada dia'
    },
    xAxis: {
        type: 'category'
    },
