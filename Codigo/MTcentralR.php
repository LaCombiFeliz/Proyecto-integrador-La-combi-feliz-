...
<?php echo '<h3 style="text-align:center;">Medidas de tendencia central para la cantidad de pasajeros que van de pie en el transporte publico</h3>';?>
...
for ($i = 0; $i < count($data); $i++) {
    $datosA[] = array("Dia"=>$data0[$i], "Cantidad"=>$datos);
}
...
<table  class="table table-striped" border="5" id="tablaDatos1">
    ...
    title: {
        text: 'Cantidad de pasajeros que van de pie en el transporte publico'
    },
    xAxis: {
        type: 'category'
    },
    ...
    series: [{
        color: '#FFA500' // Aquí puedes poner el color que prefieras
    }]
});
</script>
...
<script type="text/javascript">
    ...
    title: {
        text: 'Medidas de tendencia central por dia'
    },
    xAxis: {
        type: 'category'
    },
