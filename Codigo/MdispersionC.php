...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Medidas de dispersion general para las personas que utilizan el transporte publico'
    },
    subtitle: {
        text: ' ' +
            '<a href="" ' +
...
<script type="text/javascript">
    ...
    title: {
        text: 'Medidas de dispercion para cada dia'
    },
    xAxis: {
        type: 'category'
    },
