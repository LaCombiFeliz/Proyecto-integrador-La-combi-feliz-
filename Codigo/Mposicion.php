...
<?php echo '<h3 style="text-align:center;">Medidas de posicion para el tiempo de recorrido</h3>';?>
...
$datosdd = array (
    array(
        "Etiqueta" => "Q1",
        "Cantidad" => $cuartiles["Q1"]
    ),
    array(
        "Etiqueta" => "Q2",
        "Cantidad" => $cuartiles["Q2"]
    )
    ,
    array(
        "Etiqueta" => "Q3",
        "Cantidad" => $cuartiles["Q3"]
    )
    ,
    array(
        "Etiqueta" => "Q4",
        "Cantidad" => $cuartiles["Q4"]
    )
);
...
$datosddc = array (
    array(
        "Etiqueta" => "Percentil  $percentil" ,
        "Cantidad" => $percentil 
    ),
    array(
        "Etiqueta" => "Percentil 99 - 100",
...
<!-- Grafica cuartiles generales   container     -->
...
<!-- Tabla que representa cuartiles generales -->
...
<!-- Tabla que representa los percentiles generales -->
<table id="tablaDatos"  border="5" class="table table-striped">
        <thead>
